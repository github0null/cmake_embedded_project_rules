...
function(use_repath_for_macro__FILE__ target)
    ...
    foreach(src_file ${sources_list})
        ...
        if("${CMAKE_C_COMPILER_ID}" STREQUAL "GNU")
            get_property(all_flags SOURCE "${src_file}" PROPERTY COMPILE_OPTIONS)
            list(APPEND all_flags "-Wno-builtin-macro-redefined")
            set_property(SOURCE "${src_file}" PROPERTY COMPILE_OPTIONS ${all_flags})
        endif()
    endforeach()
endfunction()
